  ...
  try {
    ...
    const res = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        to: email,
        subject: "You are in! Endless Tales launches April 15",
        html: `
          <div style="font-family:Georgia,serif;max-width:560px;margin:0 auto;background:#0a0a10;color:#ffffff;padding:40px 32px;border-radius:12px;">
            ...
            <p style="font-size:16px;color:#ffffff;line-height:1.6;">We launch on <strong>April 15, 2026</strong>. On that day you will get an email with your <strong>14-day free trial link</strong> — no credit card needed.</p>
            ...
            <div style="background:#1a1a24;border-radius:10px;padding:20px;margin:24px 0;text-align:center;">
              <p style="font-size:15px;color:#ffffff;margin-bottom:16px;">📬 <strong>One small favor</strong> — hit the button below so our April 15 launch email lands in your inbox and not promotions.</p>
